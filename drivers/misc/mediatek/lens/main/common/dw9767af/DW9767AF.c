...
/*
 * DW9767AF voice coil motor driver
 *
 *
 */
...
static int s4DW9767SAF_ReadReg(unsigned short *a_pu2Result)
{
...
{
	int ret = 0;
	char puSendCmd5[2] = { 0x02, 0x00 };
	char puSendCmd6[2] = { 0x06, 0x0B };
	char puSendCmd7[2] = { 0x07, 0x01 };
	char puSendCmd8[2] = { 0x08, 0x49 };
	...
	i2c_master_send(g_pstAF_I2Cclient, puSendCmd8, 2);
	...
	if (*g_pAF_Opened == 1) {
		...
		ret = s4DW9767SAF_ReadReg(&InitPos);
...
/* ////////////////////////////////////////////////////////////// */
long DW9767AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9767AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9767AF_GetFileName(unsigned char *pFileName)
{
