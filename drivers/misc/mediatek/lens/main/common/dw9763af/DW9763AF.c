...
#define AF_I2C_SLAVE_ADDR        0x18	//0x18
...
static int i2c_read(u8 a_u2Addr, u8 *a_puBuff)
{
	...
	LOG_INF("[AF_TEST i2c_read] i2c_master_send i4RetValue = %d\n", i4RetValue);
//	if (i4RetValue != 2) {
	if (i4RetValue < 0) {
	...
	LOG_INF("[AF_TEST i2c_read] i2c_master_recv i4RetValue = %d\n", i4RetValue);
//	if (i4RetValue != 1) {
	if (i4RetValue < 0) {
...
static int s4AF_WriteReg(u16 a_u2Data)
{
	...
	LOG_INF("[AF_TEST s4AF_WriteReg] i2c_master_send1 i4RetValue = %d\n", i4RetValue);
    if (i4RetValue < 0) 
    {
	...
	LOG_INF("[AF_TEST s4AF_WriteReg] i2c_master_send2 i4RetValue = %d\n", i4RetValue);
    if (i4RetValue < 0) 
    {
        printk("s4AF_WriteReg() failed.\n");
        return -1;
