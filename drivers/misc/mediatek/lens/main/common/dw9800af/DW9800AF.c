...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		char puSendCmd2[2] = { (char)(0x06), (char)(0x40)};
		char puSendCmd3[2] = { (char)(0x07), (char)(0x79)};
...
{
    //[zbl] [20160706] [start] 
    #ifdef AGOLD_DW9800_AF_OPTIMIZE
	...
	//[zbl] [20160706] [start]	
        ...
        s4AF_WriteReg(512);
        msleep(20);  
        LOG_INF("[DW9800AF]Move to ini pos\n");
    #else
        g_SR = 5;
	#ifdef __HCT_LENS_NOISE_CLEAN__
		s4AF_WriteReg(700);
		msleep(15);
		s4AF_WriteReg(650);
		msleep(12); 
