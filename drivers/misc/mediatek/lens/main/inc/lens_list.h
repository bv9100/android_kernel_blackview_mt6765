...
#define DW9761AF_SetI2Cclient DW9761AF_SetI2Cclient_Main
#define DW9761AF_Ioctl DW9761AF_Ioctl_Main
#define DW9761AF_Release DW9761AF_Release_Main
#define DW9761AF_GetFileName DW9761AF_GetFileName_Main
extern int DW9761AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9761AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9761AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int DW9761AF_GetFileName(unsigned char *pFileName);
...
#define AD5823AF_GetFileName AD5823AF_GetFileName_Main
extern int AD5823AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long AD5823AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int AD5823AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int AD5823AF_GetFileName(unsigned char *pFileName);
#define DW9714AF3P9_SetI2Cclient DW9714AF3P9_SetI2Cclient_Main
#define DW9714AF3P9_Ioctl DW9714AF3P9_Ioctl_Main
#define DW9714AF3P9_Release DW9714AF3P9_Release_Main
#define DW9714AF3P9_GetFileName DW9714AF3P9_GetFileName_Main
extern int DW9714AF3P9_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9714AF3P9_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9714AF3P9_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int DW9714AF3P9_GetFileName(unsigned char *pFileName);
...
#define DW9767AF_SetI2Cclient DW9767AF_SetI2Cclient_Main
#define DW9767AF_Ioctl DW9767AF_Ioctl_Main
#define DW9767AF_Release DW9767AF_Release_Main
#define DW9767AF_GetFileName DW9767AF_GetFileName_Main
...
#define FP5510E2AFNEW_SetI2Cclient FP5510E2AFNEW_SetI2Cclient_Main
#define FP5510E2AFNEW_Ioctl FP5510E2AFNEW_Ioctl_Main
#define FP5510E2AFNEW_Release FP5510E2AFNEW_Release_Main
#define FP5510E2AFNEW_GetFileName FP5510E2AFNEW_GetFileName_Main
extern int FP5510E2AFNEW_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
	spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long FP5510E2AFNEW_Ioctl(struct file *a_pstFile,
	unsigned int a_u4Command, unsigned long a_u4Param);
extern int FP5510E2AFNEW_Release(struct inode *a_pstInode,
	struct file *a_pstFile);
extern int FP5510E2AFNEW_GetFileName(unsigned char *pFileName);
