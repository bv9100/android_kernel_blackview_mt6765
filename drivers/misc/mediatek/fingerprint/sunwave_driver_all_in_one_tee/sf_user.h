...
// platform select
#define SF_PLATFORM_SEL             SF_TEE_TRUSTKERNEL
// compatible select
#ifdef	__HCT_FINGER_SUN_MIRCO_COMPATIBLE_SUPPORT__
#define SF_COMPATIBLE_SEL           SF_COMPATIBLE_TRUSTKERNEL
#else
...
/* Dts node. */
#define COMPATIBLE_SW_FP            "mediatek,sunwave-fp"
