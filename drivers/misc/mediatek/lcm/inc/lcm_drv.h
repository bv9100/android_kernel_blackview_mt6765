...
//LCT zhougaoyang add for LCM power begin.
typedef enum {
	HCT_LCM_POWER_MODE0_SYSTEM = 0,
	HCT_LCM_POWER_MODE1_RT5081,
	HCT_LCM_POWER_MODE1_RT5081_BY_I2C,
	HCT_LCM_POWER_MODE2_V1_8,
	HCT_LCM_POWER_MODE3_V2_8,
} HCT_LCM_POWER_MODE;
//LCT zhougaoyang add for LCM power end.
...
typedef struct {
	...
	void (*dsi_set_cmdq_V3)(LCM_setting_table_V3 *para_list,
...
typedef struct {
	...
	void (*parse_dts)(const LCM_DTS *DTS,
			unsigned char force_update);
