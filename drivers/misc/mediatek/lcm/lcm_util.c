...
enum LCM_STATUS lcm_util_set_data(const  LCM_UTIL_FUNCS *lcm_util,
	char type, LCM_DATA_T1 *t1)
{
...
enum LCM_STATUS lcm_util_set_write_cmd_v1(
	const LCM_UTIL_FUNCS *lcm_util, LCM_DATA_T5 *t5,
...
enum LCM_STATUS lcm_util_set_write_cmd_v11(
	const LCM_UTIL_FUNCS *lcm_util, struct LCM_DATA_T5 *t5,
...
enum LCM_STATUS lcm_util_set_write_cmd_v2(
	const LCM_UTIL_FUNCS *lcm_util, LCM_DATA_T3 *t3,
	unsigned char force_update)
{
	/* check parameter is valid */
...
enum LCM_STATUS lcm_util_set_write_cmd_v23(
	const LCM_UTIL_FUNCS *lcm_util, void *handle,
...
enum LCM_STATUS lcm_util_set_read_cmd_v2(
	const LCM_UTIL_FUNCS *lcm_util, LCM_DATA_T4 *t4,
