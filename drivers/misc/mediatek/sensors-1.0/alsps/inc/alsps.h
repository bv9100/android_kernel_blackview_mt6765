...
typedef struct {
    ...
    int (*als_batch)(int flag, int64_t samplingPeriodNs, int64_t maxBatchReportLatencyNs);
    int (*als_flush)(void);
    ...
    int (*ps_batch)(int flag, int64_t samplingPeriodNs, int64_t maxBatchReportLatencyNs);
    int (*ps_flush)(void);
    int (*ps_get_data)(int* value, int* status);

    ssize_t (*show_als)(struct device_driver *ddri, char *buf);
    ssize_t (*show_ps)(struct device_driver *ddri, char *buf);
    ssize_t (*show_alslv)(struct device_driver *ddri, char *buf);
    ssize_t (*store_alslv)(struct device_driver *ddri, const char *buf, size_t count);
    ssize_t (*show_alsval)(struct device_driver *ddri, char *buf);
    ssize_t (*store_alsval)(struct device_driver *ddri, const char *buf, size_t count);
    ssize_t (*show_cali)(struct device_driver *ddri, char *buf);
    ssize_t (*ps_maxdiff_store)(struct device_driver *ddri, const char *buf, size_t count);
    ssize_t (*ps_maxdiff_show)(struct device_driver *ddri, char *buf);
    ssize_t (*ps_ltnct_store)(struct device_driver *ddri, const char *buf, size_t count);
    ssize_t (*ps_ltnct_show)(struct device_driver *ddri, char *buf);
    ssize_t (*ps_htnct_store)(struct device_driver *ddri, const char *buf, size_t count);
    ssize_t (*ps_htnct_show)(struct device_driver *ddri, char *buf);
    ssize_t (*show_firlen)(struct device_driver *ddri, char *buf);
    ssize_t (*store_firlen)(struct device_driver *ddri, const char *buf, size_t count);
    ssize_t (*show_ir)(struct device_driver *ddri, char *buf);
    ssize_t (*store_trace)(struct device_driver *ddri, const char *buf, size_t count);
    ssize_t (*show_trace)(struct device_driver *ddri, char *buf);
    ssize_t (*store_config)(struct device_driver *ddri, const char *buf, size_t count);
    ssize_t (*show_config)(struct device_driver *ddri, char *buf);
    ssize_t (*show_reg)(struct device_driver *ddri, char *buf);
    ssize_t (*show_send)(struct device_driver *ddri, char *buf);
    ssize_t (*store_send)(struct device_driver *ddri, const char *buf, size_t count);
    ssize_t (*show_recv)(struct device_driver *ddri, char *buf);
    ssize_t (*store_recv)(struct device_driver *ddri, const char *buf, size_t count);
    ssize_t (*show_allreg)(struct device_driver *ddri, char *buf);
    ssize_t (*show_status)(struct device_driver *ddri, char *buf);

} DISCRETEALSPS_DIRVER;
extern int DiscreteALSPS_add(DISCRETEALSPS_INDEX index, DISCRETEALSPS_DIRVER *func);
extern  DISCRETEALSPS_DIRVER* DiscreteALSPS_func(DISCRETEALSPS_INDEX index);
extern int DiscreteALSPS_init_done(DISCRETEALSPS_INDEX index, int is_done);
extern int DiscreteALSPS_is_allowed_probe(void);
#endif
