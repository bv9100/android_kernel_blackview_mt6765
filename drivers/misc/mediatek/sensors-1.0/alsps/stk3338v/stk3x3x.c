...
#if defined(__HCT_STK3X3X_PS_THRELD_LOW__) && defined(__HCT_STK3X3X_PS_THRELD_HIGH__)
	#define STK_MAX_MIN_DIFF	__HCT_STK3X3X_PS_THRELD_HIGH__
	#define STK_LT_N_CT		__HCT_STK3X3X_PS_THRELD_LOW__
	#define STK_HT_N_CT		__HCT_STK3X3X_PS_THRELD_HIGH__
#else
...
#if defined(__HCT_STK3X3X_GLASS_PS__) && defined(__HCT_STK3X3X_GLASS_HT__) && defined(__HCT_STK3X3X_GLASS_LT__)
	#define STK_H_PS		__HCT_STK3X3X_GLASS_PS__
	#define STK_H_HT		__HCT_STK3X3X_GLASS_HT__
	#define STK_H_LT		__HCT_STK3X3X_GLASS_LT__
#else
	#define STK_H_PS		500
	#define STK_H_HT		300
	#define STK_H_LT		200
...
static int stk3x3x_validate_n_handle(struct i2c_client *client)
{
	...
	if(err == 0xFF)
	{
		...
		stk3x3x_init_client(obj->client);
...
int stk3x3x_setup_eint(struct i2c_client *client)
{
	...
	if (stk3x3x_obj->irq_node)
	{
		...
		of_property_read_u32_array(stk3x3x_obj->irq_node, "debounce", ints, ARRAY_SIZE(ints));
