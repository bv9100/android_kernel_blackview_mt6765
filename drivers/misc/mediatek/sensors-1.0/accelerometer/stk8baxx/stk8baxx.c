...
#define STK_ACC_DEV_NAME "mediatek,stk8baxx"
...
#define STK_ACC_FUN(f)              pr_err(KERN_INFO STK_ACC_TAG" %s\n", __FUNCTION__)
#define STK_ACC_ERR(fmt, args...)   pr_err(KERN_ERR STK_ACC_TAG" %s %d: "fmt"\n", __FUNCTION__, __LINE__, ##args)
#define STK_ACC_LOG(fmt, args...)   pr_err(KERN_INFO STK_ACC_TAG" %s %d: "fmt"\n", __FUNCTION__, __LINE__, ##args)
...
static long stk_fops_unlocked_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
    ...
    u8 xyz[3] = {0, 0, 0};
	printk("yx add for debug 11111 GSENSOR_IOCTL_SET_CALI=%d\n",GSENSOR_IOCTL_SET_CALI);
    ...
    switch (cmd)
    {
        ...
        case GSENSOR_IOCTL_SET_CALI:
			printk("GSENSOR_IOCTL_SET_CALI stb8ba   yxc add\n");
            data = (void __user *)arg;
...
static long stk_fops_compat_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	printk(" hct drv add GSENSOR_IOCTL_SET_CALI=%d\n",GSENSOR_IOCTL_SET_CALI);
