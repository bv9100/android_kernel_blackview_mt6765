...
static const uint8_t rgbled_init_data[] = {
	...
	0xE0, /* MT6370_PMU_REG_RGBCHRINDDIM: 0x92 	E0:Software mode || 60: Auto mode*/
...
static struct mt6370_led_classdev mt6370_led_classdev[MT6370_PMU_MAXLED] = {
	{
		.led_dev =  {
#ifdef __HCT_RGB_MAX_BRIGHTNESS__
			.max_brightness = __HCT_RGB_MAX_BRIGHTNESS__,
#else
			.max_brightness = 6,
#endif
	...
	{
		.led_dev =  {
#ifdef __HCT_RED_MAX_BRIGHTNESS__
			.max_brightness = __HCT_RED_MAX_BRIGHTNESS__,
#else
			.max_brightness = 3,
#endif
			.brightness_set = mt6370_pmu_led_bright_set,
