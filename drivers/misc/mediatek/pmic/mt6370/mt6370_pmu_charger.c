...
//hct-drv add to fix loadswitch cant charging bug.
static int mt6370_chg_enable_direct_charge(struct charger_device *chg_dev, bool en)
{
	return 0;
}
//hct-drv add to fix loadswitch cant charging bug.

static int mt6370_ls_enable_direct_charge(struct charger_device *chg_dev, bool en) //hct-drv modify to fix loadswitch cant charging bug.
{
	int ret = 0;
	struct mt6370_pmu_charger_data *chg_data =
		dev_get_drvdata(&chg_dev->dev);
...
//hct-drv add to fix loadswitch cant charging bug.
static int mt6370_enable_chip(struct charger_device *chg_dev, bool en)
{
	return 0;
}
//hct-drv add to fix loadswitch cant charging bug.
...
static struct charger_ops mt6370_chg_ops = {
	...
	.enable_direct_charging = mt6370_chg_enable_direct_charge, //hct-drv add to fix loadswitch cant charging bug.
...
static struct charger_ops mt6370_ls_ops = {
	/* Direct charging */
	.enable_chip = mt6370_enable_chip,
	.enable_direct_charging = mt6370_ls_enable_direct_charge,
	//.enable_direct_charging = mt6370_enable_direct_charge, //hct-drv add to fix loadswitch cant charging bug.
