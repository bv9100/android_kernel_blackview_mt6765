...
enum DTS_GPIO_STATE {
	...
	DTS_GPIO_STATE_LCD_BIAS_ENP0,	/* hct driver wanghuadong modified */
	DTS_GPIO_STATE_LCD_BIAS_ENP1,	/* hct driver wanghuadong modified */
	DTS_GPIO_STATE_LCD_BIAS_ENN0,
	DTS_GPIO_STATE_LCD_BIAS_ENN1,
    DTS_GPIO_STATE_TP_INCELL_RST0,
    DTS_GPIO_STATE_TP_INCELL_RST1,
