...
#endif
#if (__HCT_RED_LED_MODE__ == __HCT_MT65XX_LED_MODE_GPIO__) || (__HCT_GREEN_LED_MODE__ == __HCT_MT65XX_LED_MODE_GPIO__) || (__HCT_BLUE_LED_MODE__ == __HCT_MT65XX_LED_MODE_GPIO__)
extern int led_gpio_output(int ledtype, int level);
#endif
...
#if (__HCT_RED_LED_MODE__ == __HCT_MT65XX_LED_MODE_GPIO__) || (__HCT_GREEN_LED_MODE__ == __HCT_MT65XX_LED_MODE_GPIO__) || (__HCT_BLUE_LED_MODE__ == __HCT_MT65XX_LED_MODE_GPIO__)
               return led_gpio_output(cust->data, level);
#else
