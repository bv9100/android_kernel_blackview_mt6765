...
enum IMGSENSOR_SENSOR_IDX {
	...
	//IMGSENSOR_SENSOR_IDX_MAIN3, ///4 //hct-drv disabled for useless, it will confilict with fake camera.
...
enum CAMERA_DUAL_CAMERA_SENSOR_ENUM {
	...
	DUAL_CAMERA_MAIN_FAKE_SENSOR   = 16,  
	DUAL_CAMERA_SUB_FAKE_SENSOR    = 32,  
