...
#include "ov8858mipi_2lane_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = OV8858_2LANE_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
UINT32 OV8858_MIPI_RAW_2LANE_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
