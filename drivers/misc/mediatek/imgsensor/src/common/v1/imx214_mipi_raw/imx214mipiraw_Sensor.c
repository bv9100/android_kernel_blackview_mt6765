...
static imgsensor_info_struct imgsensor_info = {
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,//SENSOR_OUTPUT_FORMAT_RAW_B
	.mclk = 24,
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    if(currefps==300)
    {
        ...
        write_cmos_sensor(0x0305,0x03);
        write_cmos_sensor(0x0306,0x00);
        write_cmos_sensor(0x0307,0x79);		//0x96
        write_cmos_sensor(0x0309,0x0A);
        write_cmos_sensor(0x030B,0x01);
        write_cmos_sensor(0x0310,0x00);

        write_cmos_sensor(0x0820,0x0F);		//0x12
        write_cmos_sensor(0x0821,0x20);		//0xC0
        write_cmos_sensor(0x0822,0x00);
        write_cmos_sensor(0x0823,0x00);
...
static kal_uint32 imx214_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
