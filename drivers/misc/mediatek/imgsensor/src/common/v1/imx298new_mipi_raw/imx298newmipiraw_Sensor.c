...
#include "imx298newmipiraw_Sensor.h"

#define IMX298_PDAF_ON
#define IMX298_OTP_ON

/****************************Modify Following Strings for Debug****************************/
#define PFX "IMX298NEW_camera_sensor"
#define LOG_1 LOG_INF("IMX298NEW,MIPI 4LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX298NEW_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
#define IMX298NEWMIPI_MaxGainIndex (115)
kal_uint16 IMX298NEWMIPI_sensorGainMapping[IMX298NEWMIPI_MaxGainIndex][2] ={
	{64 , 1  },
	{65 ,8	},
	{66 ,16 },
	{67 ,25 },
...
#ifdef IMX298_PDAF_ON
static void imx298new_apply_SPC(void)
{
...
{
	kal_uint8 iI;
    LOG_INF("[IMX298NEWMIPI]enter IMX298NEWMIPIGain2Reg function\n");
    for (iI = 0; iI < IMX298NEWMIPI_MaxGainIndex; iI++) 
	{
		if(gain < IMX298NEWMIPI_sensorGainMapping[iI][0])
		{
			return IMX298NEWMIPI_sensorGainMapping[iI][1];
		}


    }
	if(iI != IMX298NEWMIPI_MaxGainIndex)
	{
    	if(gain != IMX298NEWMIPI_sensorGainMapping[iI][0])
    	{
        	 LOG_INF("Gain mapping don't correctly:%d %d \n", gain, IMX298NEWMIPI_sensorGainMapping[iI][0]);
    	}
    }
	LOG_INF("exit IMX298NEWMIPIGain2Reg function\n");
    return IMX298NEWMIPI_sensorGainMapping[iI-1][1];
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    if(imx298_is_midid_data() == 0xdd){
	LOG_INF("Read otp flag id fail, imx298new_otp_mid_id=%x\n", imx298_is_midid_data());
...
static kal_uint32 imx298new_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	UINT32 rgain_32, grgain_32, gbgain_32, bgain_32;
    LOG_INF("imx298new_awb_gain\n");
    ...
    LOG_INF("[imx298new_awb_gain] ABS_GAIN_GR:%d, grgain_32:%d\n", pSetSensorAWB->ABS_GAIN_GR, grgain_32);
    LOG_INF("[imx298new_awb_gain] ABS_GAIN_R:%d, rgain_32:%d\n", pSetSensorAWB->ABS_GAIN_R, rgain_32);
    LOG_INF("[imx298new_awb_gain] ABS_GAIN_B:%d, bgain_32:%d\n", pSetSensorAWB->ABS_GAIN_B, bgain_32);
    LOG_INF("[imx298new_awb_gain] ABS_GAIN_GB:%d, gbgain_32:%d\n", pSetSensorAWB->ABS_GAIN_GB, gbgain_32);
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
		...
		case SENSOR_FEATURE_SET_AWB_GAIN:
            imx298new_awb_gain(pSetSensorAWB);
            break;
		/*END OF HDR CMD*/
		/*PDAF CMD*/
...
UINT32 IMX298NEW_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    IMX298NEW_MIPI_RAW_SensorInit    */
