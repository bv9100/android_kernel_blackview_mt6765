...
static imgsensor_info_struct imgsensor_info = {
    ...
    .i2c_addr_table = {0x78, 0xff}, //5409H---0x78 /5409---0x7a
    .i2c_speed = 200,
};
...
{{ 2592, 1944, 0000, 0000, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944, 0000, 0000, 2592, 1944}, // Preview 2112*1558
 ...
 { 2592, 1944, 0000, 0000, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944, 0000, 0000, 1280, 720}, //hight speed video 
 { 2592, 1944, 0000, 0000, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944, 0000, 0000, 2592, 1944},// slim video
};
...
write_cmos_sensor(0x2f,0x10);// pll clk 168M
write_cmos_sensor(0x30,0x15);
write_cmos_sensor(0x33,0x05);
write_cmos_sensor(0x34,0x00);
write_cmos_sensor(0xfd,0x01);
write_cmos_sensor(0x06,0x00); //vblank 
write_cmos_sensor(0x03,0x00); //exp time 1base
write_cmos_sensor(0x04,0xed);
write_cmos_sensor(0x09,0x01);
write_cmos_sensor(0x0a,0xb5); //hblank
write_cmos_sensor(0x24,0x60); //pga gain
write_cmos_sensor(0x01,0x01);
write_cmos_sensor(0x20,0x3d);
write_cmos_sensor(0x21,0x37);
write_cmos_sensor(0x25,0xf4); //reg dac, bl_en
write_cmos_sensor(0x26,0x0c); //vref2 1.3v, disable rd
write_cmos_sensor(0x2a,0x12); //adc range 476mv
write_cmos_sensor(0x2c,0xa0); //pixel ldo 2.6v
write_cmos_sensor(0x8a,0x55); //pixel bias 2.1u
...
write_cmos_sensor(0x11,0x40); //rst_num
write_cmos_sensor(0x51,0x15); //p1
write_cmos_sensor(0x52,0x3a); //p2
write_cmos_sensor(0x53,0x15); //p2
write_cmos_sensor(0x5d,0x00);
write_cmos_sensor(0x5e,0x00);
write_cmos_sensor(0x66,0x5c);
write_cmos_sensor(0x68,0x62); //p22
write_cmos_sensor(0x72,0x74); //p22
write_cmos_sensor(0x7b,0x01); //blk
write_cmos_sensor(0x7c,0x10);
write_cmos_sensor(0xfb,0x35); //blacklevel enable
...
write_cmos_sensor(0xfd,0x02); //digital gain
...
write_cmos_sensor(0xb6,0xc0);  //80:1lane,c0:2lane
...
write_cmos_sensor(0xfd,0x01);
write_cmos_sensor(0x3f,0x00);//mirror 0x03
write_cmos_sensor(0xfd,0x00);
}
