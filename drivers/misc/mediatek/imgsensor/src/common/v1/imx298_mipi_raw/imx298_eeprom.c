...
int imx298_is_midid_data(void)
{
	LOG_INF("imx298_otp_mid_addr_0x04 = %x\n",read_cmos_sensor_8(OTP_MID_ADDR));
        return read_cmos_sensor_8(OTP_MID_ADDR);	//(0xdd == read_cmos_sensor_8(OTP_MID_ADDR)

}

void imx298_get_otp_data(void)
{
	int i;
