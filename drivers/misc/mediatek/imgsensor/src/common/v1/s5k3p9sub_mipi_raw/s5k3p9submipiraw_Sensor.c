...
#include "s5k3p9submipiraw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3P9SUB_SENSOR_ID,		/* record sensor id defined in Kd_imgsensor.h */
...
#endif
				#ifdef HCT_3P9SXSUB_OTP_ON
				s5k3p9sxsub_get_otp_data();
				#endif
...
UINT32 S5K3p9SUB_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
