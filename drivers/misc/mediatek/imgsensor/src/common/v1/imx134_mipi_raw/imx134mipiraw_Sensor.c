...
#include "../../../mt6761/camera_hw/imgsensor_cfg_table.h"
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
    ...
    {
        case IMAGE_NORMAL:
            write_cmos_sensor_8(0x0101, 0x0000);    //Set normal
            break;
        case IMAGE_H_MIRROR:
            write_cmos_sensor_8(0x0101, 0x0010); //Set mirror
            break;
        case IMAGE_V_MIRROR:
            write_cmos_sensor_8(0x0101, 0x0020); //Set flip
            break;
        case IMAGE_HV_MIRROR:
            write_cmos_sensor_8(0x0101, 0x0030); //Set mirror and flip
            break;
        default:
