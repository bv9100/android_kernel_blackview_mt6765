...
#include "s5k3h5_mipi_Sensor.h"

#define PFX "S5K3H5_camera_sensor"
#define LOG_1 LOG_INF("S5K3H5,MIPI 4LANE\n")
#define LOG_2 LOG_INF("preview 1632*1224@30fps,1260Mbps/lane; video 1632*1224@30fps,1260Mbps/lane; capture 8M@30fps,1260Mbps/lane\n")
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
    ...
    switch (image_mirror) {
        ...
        case IMAGE_H_MIRROR:
            ...
            break;
        case IMAGE_V_MIRROR:
            write_cmos_sensor_8(0x0101,0x02);//fzx
            break;
...
UINT32 S5K3H5_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	s5k3h5_MIPI_RAW_SensorInit	*/
