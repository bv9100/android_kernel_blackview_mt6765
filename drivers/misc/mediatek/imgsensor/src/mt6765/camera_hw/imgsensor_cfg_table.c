...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	...
	{
		IMGSENSOR_SENSOR_IDX_MAIN_FAKE,
		IMGSENSOR_I2C_DEV_1,
		{
			{IMGSENSOR_HW_ID_MCLK, IMGSENSOR_HW_PIN_MCLK},
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_AVDD},
...
#if defined(IMX499_MIPI_RAW_13M)
	{
		SENSOR_DRVNAME_IMX499_MIPI_RAW_13M,
		{
...
#if defined(IMX298_MIPI_RAW)
          {
			...
			{AVDD, Vol_2800, 5},
			{DOVDD, Vol_1800, 5},
			{DVDD, Vol_1200, 5},     //DVDD must be 1200
			{AFVDD, Vol_2800, 5},
...
#endif
#if defined(IMX298NEW_MIPI_RAW)
          {
                 SENSOR_DRVNAME_IMX298NEW_MIPI_RAW,                            
                 {
			{PDN, Vol_Low, 5},
			{RST, Vol_Low, 5},
			{AVDD, Vol_2800, 5},
...
#if defined(GC0310_MIPI_YUV_SUB)
		{SENSOR_DRVNAME_GC0310_MIPI_YUV_SUB,
			{
				{PDN,	Vol_High, 1},
				{RST,   Vol_Low,  1},
...
#if defined(S5K3P9SUB_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K3P9SUB_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
...
#if defined(S5K3P9SXMAIN_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K3P9SXMAIN_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
...
#endif
#if defined(SP8409_MIPI_RAW)
	{SENSOR_DRVNAME_SP8409_MIPI_RAW,
	  {
			{PDN,   Vol_Low,  1},
			{RST,   Vol_Low,  1},
			{DOVDD, Vol_1800, 5},
...
#endif
#if defined(OV8858_MIPI_RAW_2LANE)
	{
		SENSOR_DRVNAME_OV8858_MIPI_RAW_2LANE,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
