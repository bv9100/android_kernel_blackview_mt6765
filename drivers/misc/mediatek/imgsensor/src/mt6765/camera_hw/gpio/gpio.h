...
enum GPIO_CTRL_STATE {
	...
	/* zhouhongbin add 2017.09.06 */
	/* Main Fake */
	GPIO_CTRL_STATE_CAM_FAKE_PDN_H,
	GPIO_CTRL_STATE_CAM_FAKE_PDN_L,
	GPIO_CTRL_STATE_CAM_FAKE_RST_H,
	GPIO_CTRL_STATE_CAM_FAKE_RST_L,
	GPIO_CTRL_STATE_LDO_MAIN_FAKE_VCAMA_H,
	GPIO_CTRL_STATE_LDO_MAIN_FAKE_VCAMA_L,
	GPIO_CTRL_STATE_LDO_MAIN_FAKE_VCAMD_H,
	GPIO_CTRL_STATE_LDO_MAIN_FAKE_VCAMD_L,
	/* add over */

	/* zhouhongbin add 2017.09.14 */
	/* Sub Fake */
	GPIO_CTRL_STATE_CAM_SUB_FAKE_PDN_H,
	GPIO_CTRL_STATE_CAM_SUB_FAKE_PDN_L,
	GPIO_CTRL_STATE_CAM_SUB_FAKE_RST_H,
	GPIO_CTRL_STATE_CAM_SUB_FAKE_RST_L,
	GPIO_CTRL_STATE_LDO_SUB_FAKE_VCAMA_H,
	GPIO_CTRL_STATE_LDO_SUB_FAKE_VCAMA_L,
	GPIO_CTRL_STATE_LDO_SUB_FAKE_VCAMD_H,
	GPIO_CTRL_STATE_LDO_SUB_FAKE_VCAMD_L,
	/* add over */
