...
#define OTP_DATA                s5k3p3sp_eeprom_data
#define OTP_PLATFORM_CHOICE     0x09     //bit0:awb, bit1:af, bit3:lsc
#define OTP_FLAG_ADDR           0x0000
#define OTP_LENSID_ADDR         0x0005
#define AWB_ADDR                0x0012
#define AWB_CHECK_ADDR          0x001A
#define LSC_ADDR                0x001C
#define LSC_CHECK_ADDR          0x0768
#define AF_ADDR                 0x0000
#define AF_CHECK_ADDR           0x0000
#define CHECKSUM_METHOD(x,addr)  \
( (x % 255) == read_cmos_sensor_8(addr) )

#define GOLDEN_AWB_R			0x59
#define GOLDEN_AWB_GR			0xb3
#define GOLDEN_AWB_GB			0xb3
#define GOLDEN_AWB_B			0x74
...
int s5k3p3sp_is_otp_data(void)
{
	LOG_INF("3p3sp_otp_addr_0x00 = %x\n",read_cmos_sensor_8(OTP_FLAG_ADDR));
...
int s5k3p3sp_is_lensid_data(void)
{
	LOG_INF("3p3sp_otp_addr_0x05 = %x\n",read_cmos_sensor_8(OTP_LENSID_ADDR));
    if(0xF8 == read_cmos_sensor_8(OTP_LENSID_ADDR))
	{
        LOG_INF("OTP DATA Invalid!!!\n");
        return 0;
    }
...
void s5k3p3sp_get_otp_data(void)
{
	int i;
