 ...
 *
 ****************************************************************************/
#ifndef _S5K3P3SPMIPI_SENSOR_H
#define _S5K3P3SPMIPI_SENSOR_H
...
extern void s5k3p3sp_awb_load(void);
extern void s5k3p3sp_get_otp_data(void);
extern int s5k3p3sp_is_otp_data(void);
extern int s5k3p3sp_is_lensid_data(void);
#endif
